...
// array<LeaderboardEntry@> RefreshLeaderboard(int currentPbTime){
...
//             auto timeEntryFunc = startnew(CoroutineFuncUserdata(SpecificTimeEntryCoroutine), Integer(allPositionToGet[i]));
//             coroutines.InsertLast(timeEntryFunc);
//         }
//         auto medalEntryFunc = startnew(CoroutineFunc(AddMedalsEntriesCoroutine));
